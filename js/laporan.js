function updateDashboardStats() {
        ...
        function openSetupModal() { document.getElementById('modal-setup-guide').classList.remove('hidden'); }
        function closeSetupModal() { document.getElementById('modal-setup-guide').classList.add('hidden'); }
